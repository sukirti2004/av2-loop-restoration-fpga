...
module tb_multi_ru_verify_h3;
    ...
    initial begin
        ...
        //
        // CRITICAL: with COL_DELAY=3 (not the old ~1542-cycle SWAP_DELAY), the
        // FIRST swap fires at input pixel 256+COL_DELAY=259 -- almost
        // immediately. LOAD_START must be SMALL (shadow needs RU1 ready well
        // before 259), not large like the old single-delay design needed.
        // Using LOAD_START=280 here originally put every load one full boundary
        // cycle late -- shadow was always one step behind. LOAD_START=20 gives
        // ~13 cycles to write + margin before the first fire at 259.
        begin : stream
